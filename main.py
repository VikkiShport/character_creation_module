...
def attack(char_name: str, char_class: str) -> str:
    """Возвращает результат нанесённого урона противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Возвращает результат блокированного урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Возвращает результат применённого умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Возвращает строку для ввода действия выбранным персонажем."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Выводит характеристики выбранного персонажа."""
...
def main() -> None:
    """Выводит приветсвие и предложение выбора персонажа."""
